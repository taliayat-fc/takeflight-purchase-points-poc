  ...
  return (
    <div style={{ backgroundColor: colors.background.white, minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <Container maxWidth="sm">
        <div style={{ padding: '24px 24px 48px', display: 'flex', flexDirection: 'column', gap: '46px' }}>
      ...
      <div style={{ marginTop: 'auto', borderTop: `1px solid ${colors.border.light}` }}>
        <div style={{ padding: '14px 24px 12px' }}>
          <Button variant="primary" size="lg" fullWidth={true} onClick={handlePurchase}>Purchase {pointsAmount.toLocaleString()} pts</Button>
        </div>
